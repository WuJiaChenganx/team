...
const router = new VueRouter({
  routes: [
    ...
    },
    {
      ...
      name: "项目详情",
      component: () => import("../views/scientificResearch/projectDetail.vue"),
    },
    {
    ...
    },
    {
      ...
      name: "课程教学",
      component: () => import("../views/education/curriculum.vue"),
    },
    // 测试用

    {
      path: "/test",
      name: "测试",
      component: () => import("../components/home/resourceSharing.vue"),
    },
  ],
});
// 跳转后自动返回页面顶部
