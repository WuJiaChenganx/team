...
const router = new VueRouter({
    routes: [
        ...
        },
        {
            ...
            name: "本科生教学",
            component: () =>
                import ("../views/education/undergraduate.vue"),
        },
        {
            path: "/education/master",
            name: "研究生教学",
            component: () =>
                import ("../views/education/master.vue"),
        },
        {
            path: "/education/achievements",
            name: "教学成果",
            component: () =>
                import ("../views/education/achievements.vue"),
        },
        // 科技成果以及成果荣誉
        {
            path: "/prize",
            name: "成果荣誉",
            redirect: "/prize/prize",
        },
        {
            path: "/prize/prize",
            name: "科技成果",
            component: () =>
                import ("../views/prize/prize.vue"),
        },
        {
            path: "/prize/honour",
            name: "团队荣誉",
            component: () =>
                import ("../views/prize/honour.vue"),
        },
        ...
        },
        {
            ...
            name: "国内交流",
            component: () =>
                import ("../views/cooperation/domestic.vue"),
        },
        {
            path: "/cooperation/international",
            name: "国际交流",
            component: () =>
                import ("../views/cooperation/international.vue"),
        },
        // 测试用
        {
            path: "/test",
